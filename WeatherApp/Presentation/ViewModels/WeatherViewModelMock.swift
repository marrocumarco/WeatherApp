...
public class WeatherViewModelMock: WeatherViewModel {
    var weather: WeatherUI? = WeatherUI(locationName: "Escovedum", weatherDescription: "Basca", weatherDetails: "Baschixedda", temperature: "33°", minimumTemperature: "15°", maximumTemperature: "3°", iconName: "cloud")
